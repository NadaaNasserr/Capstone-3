...
private final ReviewRepository reviewRepository;
    ...
    public void addCar(CarDTO carDTO) {
        ...
        Car car = new Car(null, carDTO.getType(), carDTO.getBrand(), carDTO.getColor(), carDTO.getModel(), carDTO.getDaily_price(),
                carDTO.getHourly_price(), carDTO.getMonthly_price(), carDTO.getWeekly_price(), carDTO.getAuthorized(),
